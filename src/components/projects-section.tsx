...
export function ProjectsSection() {
  return (
    <section id="projects" className="mb-16 scroll-mt-16 lg:mb-24 lg:scroll-mt-24">
      <div className="sticky top-0 z-20 -mx-6 mb-2 bg-background/80 px-6 py-5 backdrop-blur lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
        <h2 className="lg:text-lg text-sm font-bold uppercase tracking-widest text-foreground">
          Projects
        </h2>
      </div>
      <div>
